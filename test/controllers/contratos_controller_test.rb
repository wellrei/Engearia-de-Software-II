...
class ContratosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post contratos_url, params: { contrato: { descricao: @contrato.descricao, nome: @contrato.nome } }
    end
  ...
  test "should update contrato" do
    patch contrato_url(@contrato), params: { contrato: { descricao: @contrato.descricao, nome: @contrato.nome } }
